...
const STATUS_LABEL: Record<string,string> = { estrategia:'Estratégia', aguardando_aprovacao_crono:'Ag. crono', captacao:'Captação', producao:'Produção', revisao_interna:'Revisão', aguardando_aprovacao:'Aguardando aprovação', ajuste:'Ajuste solicitado', aprovado:'Aprovado', agendado:'Agendado', publicado:'Publicado' }
