...
export default function PostPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="border-b border-[var(--color-border)] px-6 py-4 flex items-center gap-3 bg-white">
          ...
          <div className="p-6 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <textarea
                ...
                rows={3}
                className="w-full border border-[var(--color-border)] rounded-xl px-3 py-2 text-sm text-[var(--color-text-primary)] outline-none focus:border-[var(--color-text-primary)] transition-colors bg-white resize-none"
              />
