...
import { fetchSocialItems, filterSocialItems, SocialItem, SocialFilters, ScheduleRow } from '@/lib/socialItems'
...
const EMPTY_FILTERS: SocialFilters = { clientIds: new Set(), types: new Set(), dateFilter: 'todos', search: '' }
